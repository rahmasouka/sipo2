...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-2 mt-2 mb-2"><span class="fw-bolder">List Obat Terpakai</h4>
                ...
                <table class="table table-striped datatable_init">
                    <thead>
                        <tr>
                            ...
                            <th class="align-middle">Tgl Penggunaan</th>
                            <th class="align-middle">Terpakai</th>
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($result as $key => $v)
                            <tr>
                                ...
                                <td>{{ $v->jenis_obat ?? '-' }}</td>
                                <td>{{ $v->created_at }}</td>
                                <td class="text-end"> {!! number_format($v->terpakai) !!} {{ $v->nama_satuan }}
                                </td>
                                <td>
